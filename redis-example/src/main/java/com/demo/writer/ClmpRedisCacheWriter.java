...
/**
 * @auther gzhen
 * @date 2023-10-08  14:13
 * @description
 */

@Slf4j
public class ClmpRedisCacheWriter implements RedisCacheWriter {

    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;

    public ClmpRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public ClmpRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {

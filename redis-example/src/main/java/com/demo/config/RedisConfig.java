...
import com.demo.constant.CacheConstant;
import com.demo.constant.GlobalConstants;
import com.demo.receiver.RedisReceiver;
import com.demo.writer.ClmpRedisCacheWriter;
...
//	}
    ...
    public CacheManager cacheManager(LettuceConnectionFactory factory) {
        ...
        RedisCacheWriter writer = new ClmpRedisCacheWriter(factory, Duration.ofMillis(50L));
    ...
    public RedisMessageListenerContainer redisContainer(RedisConnectionFactory redisConnectionFactory) {
        ...
        container.addMessageListener(commonListenerAdapter1(null), new ChannelTopic(GlobalConstants.REDIS_TOPIC_NAME_1));
        container.addMessageListener(commonListenerAdapter2(null), new ChannelTopic(GlobalConstants.REDIS_TOPIC_NAME_2));
        return container;
    }
    ...
    @Bean
    MessageListenerAdapter commonListenerAdapter1(RedisReceiver redisReceiver) {
    ...
    @Bean
    MessageListenerAdapter commonListenerAdapter2(RedisReceiver redisReceiver) {
        MessageListenerAdapter messageListenerAdapter = new MessageListenerAdapter(redisReceiver, "onMessage2");
        messageListenerAdapter.setSerializer(jacksonSerializer());
        return messageListenerAdapter;
    }
